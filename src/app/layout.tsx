...
export const metadata: Metadata = {
  title: "MWR Engenharia | Energia Solar e Aquecimento",  description: "Soluções especializadas de energia solar, aquecimento de água e piscina em Indaiatuba-SP. Equipe técnica qualificada com 4.8⭐ de avaliação.",  keywords: "energia solar, aquecimento solar, aquecimento piscina, sistemas térmicos, Indaiatuba",  metadataBase: new URL("https://mwrengenharia.com.br"),
  openGraph: {
    title: "MWR Engenharia | Energia Solar e Aquecimento Inteligente",    description: "Projetos completos de energia solar com engenharia especializada e suporte pós-venda.",    type: "website",    siteName: "MWR Engenharia",    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AX2VppTtnuttzyDIZfEQzhVaYa/uploaded-1772724757410-boo53a04.jpg",        alt: "Instalação de painéis solares"},
    ],
  },
  twitter: {
    card: "summary_large_image",    title: "MWR Engenharia | Energia Solar Inteligente",    description: "Soluções de energia solar e aquecimento para sua residência."},
};
